 ...
 * @property {(options:DeliveryReceipts) => DeliveryResponse} drStatus
 * @property {(options:RepliesRequest) => DeliveryResponse} replies
 * @property {() => UserSettingsResponse} settings
 */
