    ...
    async #deliveryStatus(options) {
        ...
        try {
            ...
            if (drStatusRequest.status === 200) {
                /** @type {DeliveryResponse} response */
                const response = await drStatusRequest.json()
                return response
            } else {
    ...
    async #checkReplies(options) {
        ...
        try {
            ...
            if (repliesRequest.status === 200) {
                ...
                const response = await repliesRequest.json()
                return response
            } else {
    ...
    async #userSettings() {
        ...
        try {
            ...
            if (userSettingsRequest.status === 200) {
                ...
                const response = await userSettingsRequest.json()
    ...
    async #manageOptouts(options) {
        ...
        try {
            ...
            if (optoutsRequest.status === 200) {
                ...
                const response = await optoutsRequest.json()
                return response
            } else {
    ...
    async #crmLists(options) {
        ...
        try {
            ...
            if (listRequest.status === 200) {
                /** @type {ListResponse} */
                const response = await listRequest.json()
                return response
            } else {
